      ...
      node -e "
        ...
        async function runQuery() {
          try {
            ...
            const leads = await db.all('SELECT id, name, phone, city, origem, valor_desejado, renda, prioridade FROM leads WHERE organization_id = 1 ORDER BY id DESC LIMIT 20');
            console.log('\\\\n=== LEADS (clientes) - últimos 20 ===');
            if (leads.length === 0) {
