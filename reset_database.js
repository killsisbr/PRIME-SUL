      ...
      node -e "
        ...
        async function resetDatabase() {
          try {
            ...
            // We explicitly want to keep sessions if it exists
            const exclude = ['sessions']; // Add other tables to preserve here if needed
            ...
            // Also clean up any orphaned sqlite_sequence entries (for tables that might have been excluded)
            // But we already handled this in the loop above for non-excluded tables
