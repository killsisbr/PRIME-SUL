...
async function seedMockData() {
    ...
    const mockLeads = [
        { name: 'João Carlos Oliveira', phone: '5511981112233', status: 'sim', renda: '4500', valor: '12000', cpf: '123.456.789-01', prioridade: 'alta', score: 850, tags: 'INSS,Margem Livre', obs: 'Aposentado INSS, prefere atendimento no período da manhã.', seller_id: carlosId },
        { name: 'Ana Paula Ferreira', phone: '5511982223344', status: 'enviados', renda: '3200', valor: '8000', cpf: '234.567.890-12', prioridade: 'media', score: 720, tags: 'FGTS,Saque Aniversario', obs: 'Trabalha em empresa privada, saldo FGTS R$ 14.000', seller_id: carlosId },
        { name: 'Marcos Vinicius Santos', phone: '5511983334455', status: 'novos', renda: '6800', valor: '25000', cpf: '345.678.901-23', prioridade: 'alta', score: 910, tags: 'Servidor Publico,SIAPE', obs: 'Servidor Federal, margem cheia.', seller_id: marianaId },
        { name: 'Beatriz Lima Mendes', phone: '5511984445566', status: 'sim', renda: '2900', valor: '5000', cpf: '456.789.012-34', prioridade: 'media', score: 780, tags: 'INSS,Portabilidade', obs: 'Contrato digitado no banco BB. Proposta nº 884192.', seller_id: marianaId },
        { name: 'Lucas Gabriel Costa', phone: '5511985556677', status: 'sim', renda: '5100', valor: '18000', cpf: '567.890.123-45', prioridade: 'alta', score: 840, tags: 'INSS,Refin', obs: 'Pediu troco mínimo de R$ 4.000 no refinanciamento.', seller_id: carlosId },
        { name: 'Fernanda Rocha', phone: '5511986667788', status: 'enviados', renda: '3800', valor: '9500', cpf: '678.901.234-56', prioridade: 'baixa', score: 650, tags: 'FGTS', obs: 'Aguardando liberação de lote pelo aplicativo do FGTS.', seller_id: robertoId },
        ...
        { name: 'Camila Rodrigues', phone: '5511988889900', status: 'novos', renda: '7200', valor: '30000', cpf: '890.123.456-78', prioridade: 'alta', score: 930, tags: 'Servidor Estadual,Margem Livre', obs: 'Policial Militar SP. Quer simulação em 84x.', seller_id: marianaId },
        { name: 'Ricardo Alves', phone: '5511989990011', status: 'sim', renda: '4100', valor: '11000', cpf: '901.234.567-89', prioridade: 'media', score: 790, tags: 'INSS', obs: 'Pensionista do INSS. Documentação enviada via WhatsApp.', seller_id: carlosId },
        { name: 'Patricia Souza Lima', phone: '5511990001122', status: 'sim', renda: '8500', valor: '42000', cpf: '012.345.678-90', prioridade: 'alta', score: 950, tags: 'SIAPE,Margem Livre', obs: 'Pago via PIX em conta corrente Banco do Brasil.', seller_id: robertoId },
        { name: 'Thiago Henrique', phone: '5511991112233', status: 'novos', renda: '2500', valor: '4500', cpf: '111.222.333-44', prioridade: 'media', score: 680, tags: 'FGTS', obs: 'Simulou Saque Aniversário.', seller_id: carlosId },
        { name: 'Vanessa Camargo', phone: '5511992223344', status: 'enviados', renda: '3900', valor: '10000', cpf: '222.333.444-55', prioridade: 'alta', score: 810, tags: 'INSS', obs: 'Dúvidas sobre taxa de juros do consignado.', seller_id: marianaId }
    ];
